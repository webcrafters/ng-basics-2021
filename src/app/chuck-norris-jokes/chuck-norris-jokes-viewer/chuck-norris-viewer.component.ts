...
@Component({
  selector: 'app-chuck-norris-viewer',
  templateUrl: './chuck-norris-viewer.component.html',
  styleUrls: ['./chuck-norris-viewer.component.scss'],
})
export class ChuckNorrisViewerComponent implements OnInit {
